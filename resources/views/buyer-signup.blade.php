		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	  	...
	  	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">	
			<div class="form-group field-distance">
                    ...
                    name="user_email" id="phone" placeholder="Contact Number">                
                </div>
	  		</div>
	  	</div>	
	  	</div>	
	  	<div class="row">
			...
			<div class="form-group field-distance">
		  	<div class="col-sm-10">
				<select class="form-control  validate[required]" style="text-align-last:center;" placeholder="Select type">
	  	...
	  	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">	
			<div class="form-group field-distance">
	   	  		<div class="col-sm-10 col-sm-offset-2">
	      			<input type="text" class="form-control  validate[required]" id="address" placeholder="Address">
	    		</div>
	  		</div>
	  	</div>	
	  	</div>	<!-- end row --> 
